...
export declare class LucidProvider implements LucidProviderContract<LucidProviderModel> {
     ...
     * inside it
     */
    getUserFor(user: InstanceType<LucidProviderModel> | null): ProviderUserContract<import("@ioc:Adonis/Lucid/Model").LucidRow & {
        password?: string | undefined;
        rememberMeToken?: string | null | undefined;
    }> | LucidUser<LucidProviderModel>;
    /**
     ...
     */
    after(event: string, callback: (...args: any[]) => Promise<void>): this;
    /**
     * Returns a user instance using the primary key value
     */
    findById(id: string | number): Promise<ProviderUserContract<import("@ioc:Adonis/Lucid/Model").LucidRow & {
        password?: string | undefined;
        rememberMeToken?: string | null | undefined;
    }> | LucidUser<LucidProviderModel>>;
    /**
     ...
     */
    findByRememberMeToken(id: string | number, value: string): Promise<ProviderUserContract<import("@ioc:Adonis/Lucid/Model").LucidRow & {
        password?: string | undefined;
        rememberMeToken?: string | null | undefined;
    }> | LucidUser<LucidProviderModel>>;
    /**
     ...
     * their defined uids.
     */
    findByUid(uidValue: string): Promise<ProviderUserContract<import("@ioc:Adonis/Lucid/Model").LucidRow & {
        password?: string | undefined;
        rememberMeToken?: string | null | undefined;
    }> | LucidUser<LucidProviderModel>>;
    /**
