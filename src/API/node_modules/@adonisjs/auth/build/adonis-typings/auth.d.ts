...
declare module '@ioc:Adonis/Addons/Auth' {
     ...
     */
    export type GetProviderRealUser<Provider extends keyof ProvidersList> = UnWrapProviderUser<ReturnType<ProvidersList[Provider]['implementation']['getUserFor']>>;
    /**
     ...
     */
    export type ExtendProviderCallback = (application: ApplicationContract, config: any) => UserProviderContract<any>;
    /**
     * Shape of the callback accepted to add new guards
     */
    export type ExtendGuardCallback = (application: ApplicationContract, mapping: string, config: any, provider: UserProviderContract<any>, ctx: HttpContextContract) => GuardContract<keyof ProvidersList, keyof GuardsList>;
    /**
